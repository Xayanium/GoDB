...
type RequestVoteArgs struct {
	...
	Term          int32                  `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"`                                       // 请求投票的候选人 任期号
	CandidateId   int32                  `protobuf:"varint,2,opt,name=candidate_id,json=candidateId,proto3" json:"candidate_id,omitempty"`      // 请求投票的候选人 ID
	LastLogIndex  int32                  `protobuf:"varint,3,opt,name=last_log_index,json=lastLogIndex,proto3" json:"last_log_index,omitempty"` // 候选人最后日志条目的索引
	LastLogTerm   int32                  `protobuf:"varint,4,opt,name=last_log_term,json=lastLogTerm,proto3" json:"last_log_term,omitempty"`    // 候选人最后日志条目的任期号
...
type RequestVoteReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Term          int32                  `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"`                                  // 接收方节点当前的任期
	VoteGranted   bool                   `protobuf:"varint,2,opt,name=vote_granted,json=voteGranted,proto3" json:"vote_granted,omitempty"` // 接收方节点是否投票
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LogEntry struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Term          int32                  `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"`                                     // 该日志条目产生时 leader 的任期
	CommandValid  bool                   `protobuf:"varint,2,opt,name=command_valid,json=commandValid,proto3" json:"command_valid,omitempty"` // Raft层 通过 applyCh 通知上层时，用来区分该条目是否需要上层的状态机执行
	Command       []byte                 `protobuf:"bytes,3,opt,name=command,proto3" json:"command,omitempty"`                                // 上层传入的命令内容
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AppendEntriesArgs struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Term          int32                  `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"`                                       // Leader 的任期号
	LeaderId      int32                  `protobuf:"varint,2,opt,name=leader_id,json=leaderId,proto3" json:"leader_id,omitempty"`               // Leader 的 ID，便于 Follower 重定向客户端
	PrevLogIndex  int32                  `protobuf:"varint,3,opt,name=prev_log_index,json=prevLogIndex,proto3" json:"prev_log_index,omitempty"` // leader 认为 Follower 的最后一条日志在自己本地日志中的Index
	PrevLogTerm   int32                  `protobuf:"varint,4,opt,name=prev_log_term,json=prevLogTerm,proto3" json:"prev_log_term,omitempty"`    // prev_log_index 日志产生时对应的 leader term
	Entries       []*LogEntry            `protobuf:"bytes,5,rep,name=entries,proto3" json:"entries,omitempty"`                                  // leader 希望 follower 追加（或覆盖）的一串日志
	LeaderCommit  int32                  `protobuf:"varint,6,opt,name=leader_commit,json=leaderCommit,proto3" json:"leader_commit,omitempty"`   // leader 当前已提交的位置，用于 follower 推进自己的 commitIndex
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AppendEntriesReply struct {
	state   protoimpl.MessageState `protogen:"open.v1"`
	Term    int32                  `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"`       // follower 当前任期
	Success bool                   `protobuf:"varint,2,opt,name=success,proto3" json:"success,omitempty"` // follower 这次追加是否成功
...
type InstallSnapshotArgs struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Term              int32                  `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"`                                                      // Leader 的任期号
	LeaderId          int32                  `protobuf:"varint,2,opt,name=leader_id,json=leaderId,proto3" json:"leader_id,omitempty"`                              // Leader 的 ID
	LastIncludedIndex int32                  `protobuf:"varint,3,opt,name=last_included_index,json=lastIncludedIndex,proto3" json:"last_included_index,omitempty"` // leader要求follower安装的快照中，最后一条日志index
	LastIncludedTerm  int32                  `protobuf:"varint,4,opt,name=last_included_term,json=lastIncludedTerm,proto3" json:"last_included_term,omitempty"`    // leader要求follower安装的快照中，最后一条日志term
	Snapshot          []byte                 `protobuf:"bytes,5,opt,name=snapshot,proto3" json:"snapshot,omitempty"`                                               // leader要求follower安装的快照的数据
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type InstallSnapshotReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Term          int32                  `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"` // 当前任期号，用于 Leader 更新自己
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_raft_proto_rawDesc = "" +
	...
	"\bLogEntry\x12\x12\n" +
	"\x04term\x18\x01 \x01(\x05R\x04term\x12#\n" +
	"\rcommand_valid\x18\x02 \x01(\bR\fcommandValid\x12\x18\n" +
	"\acommand\x18\x03 \x01(\fR\acommand\"\xdd\x01\n" +
	...
	"\x12last_included_term\x18\x04 \x01(\x05R\x10lastIncludedTerm\x12\x1a\n" +
	"\bsnapshot\x18\x05 \x01(\fR\bsnapshot\"*\n" +
	"\x14InstallSnapshotReply\x12\x12\n" +
	"\x04term\x18\x01 \x01(\x05R\x04term2\xd9\x01\n" +
	"\vRaftService\x12<\n" +
...
var file_proto_raft_proto_depIdxs = []int32{
	...
	1, // 4: raft.RaftService.RequestVote:output_type -> raft.RequestVoteReply
	4, // 5: raft.RaftService.AppendEntries:output_type -> raft.AppendEntriesReply
